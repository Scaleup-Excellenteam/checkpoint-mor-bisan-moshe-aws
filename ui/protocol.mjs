...
export const errors = {
  ...
  reputation_unavailable: 'Link safety could not be checked. Try again later.',
  reputation_review_required: 'This link could not be confirmed safe. Remove it before sending.',
